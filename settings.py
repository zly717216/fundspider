...
REQUEST_CONCURRENCY_SLEEP = 0.3           # 单位秒，每 REQUEST_CONCURRENCY_COUNT 个请求休眠1秒
...
# 数据管道
ITEM_PIPELINES = {
    "fundspider.pipelines.FundListPipeline": 100,
    "fundspider.pipelines.FundPipeline": 150,
    "fundspider.pipelines.FundHoldPipeline": 200,
    "fundspider.pipelines.StockChangePipeline": 300,
    "fundspider.pipelines.NetWorthPipeline": 400,
    "fundspider.pipelines.AccWorthPipeline": 500,
    "fundspider.pipelines.GrowthRatePipeline": 600,
    "fundspider.pipelines.RankingPipeline": 700,
    "fundspider.pipelines.FundManagerPipeline": 800,
}
